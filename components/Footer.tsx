...
export function Footer() {
  ...
  const footerLinks = {
    ...
    resources: [
      { name: 'Take the Profit Quiz', href: '/quiz' },
          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">hello@wabi-sabi.analytics</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-amber-500/10 to-orange-400/10 rounded-2xl p-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              <input
                ...
                className="flex-1 px-4 py-3 rounded-xl bg-dark-800 border border-dark-600 text-white placeholder-gray-400 focus:outline-none focus:border-amber-400"
              />
              <button className="bg-gradient-to-r from-amber-500 to-orange-400 text-white px-6 py-3 rounded-xl font-semibold hover:shadow-lg transition-all duration-300">
                Subscribe
              </button>
            </div>
          </div>
