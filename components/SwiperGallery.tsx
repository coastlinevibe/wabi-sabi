  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-black/60 backdrop-blur-md flex items-center justify-center p-2 sm:p-4 animate-in fade-in duration-500">
      ...
      <button
        ...
        className="absolute top-3 right-3 sm:top-6 sm:right-6 z-10 w-10 h-10 sm:w-14 sm:h-14 flex items-center justify-center bg-white/10 hover:bg-orange-500/90 backdrop-blur-lg border border-white/20 hover:border-orange-500 rounded-full transition-all duration-300 hover:scale-110 hover:rotate-90 active:scale-95 group animate-in slide-in-from-top-right duration-700"
      >
        <X className="w-5 h-5 sm:w-6 sm:h-6 text-white group-hover:text-white transition-colors" />
      </button>

      {/* Main Content */}
      <div className="relative w-full max-w-6xl h-[90vh] sm:h-[85vh] bg-gradient-to-br from-white to-blue-50 rounded-2xl sm:rounded-3xl shadow-2xl overflow-visible animate-in zoom-in-95 slide-in-from-bottom-8 duration-700">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8 p-4 sm:p-8 md:p-12 pb-20 sm:pb-24 h-full overflow-y-auto">
          {/* Left: Images */}
          <div className="flex items-center justify-center bg-gradient-to-br from-blue-100 to-blue-50 rounded-xl sm:rounded-2xl p-4 sm:p-8 relative overflow-hidden group min-h-[200px] sm:min-h-[300px]">
            ...
            <img
              ...
              className="absolute w-20 sm:w-28 md:w-36 object-contain shadow-2xl rounded-lg sm:rounded-xl z-20 animate-in fade-in slide-in-from-left-8 duration-700 delay-150 hover:scale-110 transition-all duration-500"
              style={{ 
          ...
          <div className="flex flex-col justify-center space-y-3 sm:space-y-5">
            ...
            <p className="text-slate-700 leading-relaxed text-sm sm:text-lg animate-in fade-in slide-in-from-bottom-4 duration-500 delay-300">
            ...
            <div className="text-xs sm:text-sm text-slate-600 pt-2 sm:pt-4 space-y-1 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-500">
              <div className="font-bold text-slate-900 text-sm sm:text-base">{currentSlide.ghostName}</div>
              <div className="text-slate-700">{currentSlide.ghostTitle}</div>
            </div>
          </div>
        </div>
