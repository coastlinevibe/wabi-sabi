...
Hidden value flows quietly through your business, waiting to be discovered and shaped with care.
          ...
          <div className="mt-8 flex justify-center gap-6 flex-wrap">
            ...
            <Link href="#system-works" className="inline-flex items-center px-6 py-4 bg-slate-900/80 border border-slate-700 text-slate-100 text-sm font-medium rounded-xl hover:bg-slate-800 transition-all">
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            >
              ...
              <div className="text-sm text-slate-400">businesses — leaner systems, stronger results</div>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
      ...
      <section className="py-20 bg-slate-900">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="text-center">
            <Link href="/portfolio" className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-amber-500 to-orange-400 text-white rounded-xl font-semibold hover:from-amber-600 hover:to-orange-500 transition-all duration-300">
